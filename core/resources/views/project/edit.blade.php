<form class="" action="{{URL::to('/projects/edit/')}}" method="post">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="md-form">
                <input type="text" id="target" class="form-control" name="code" placeholder=" " required value="{{$data->code}}">
    ...
    <div class="row">
        <div class="col">
            <div class="md-form">
                ...
                <textarea name="desc" id="" cols="30" rows="5" {{($data->hasPreOk == 1) ? "" : "disabled"}} class="form-control md-textarea">{{$data->desc}}</textarea>
            </div>
        </div>
    </div>
